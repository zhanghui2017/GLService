...
import com.gengli.glservice.util.CustomRotateAnim;
 ...
 */
public class AddImgListAdapter extends BaseAdapter {
     ...
     * 所有图片的路径集合
     */
    public List<String> imageItemData = new ArrayList<String>();
     ...
     */
    public AddImgListAdapter(Context context, int imagesum) {
