...
public class CommandPhotoUtil {
     ...
     * 存放图片的容器
     */
    private FormGridView mGridView;

    /**
     * GridView适配器
     */
    private AddImgListAdapter gridAdapter;
     ...
     */
    public CommandPhotoUtil(Context mContext, FormGridView gridView, AddImgListAdapter gridAdapter, PhotoSystemOrShoot selectPhoto) {
